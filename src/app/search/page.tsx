                      ...
                      <div className="p-5">
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                          ...
                          <div className="flex items-center gap-4 lg:flex-col lg:items-end">
                            ...
                            <button
                              onClick={() => handleSelectFlight(flight)}
                              className="px-5 py-2.5 bg-gradient-to-r from-[#f97316] to-[#ea580c] hover:from-[#ea580c] hover:to-[#dc2626] text-white font-bold text-sm rounded-xl transition-all shadow-lg shadow-orange-500/20 hover:shadow-orange-500/40 flex items-center gap-2 whitespace-nowrap"
                            >
                              Selecionar
