...
function generateFlights(): Flight[] {
  const baseFlights: Omit<Flight, "id" | "departureTime" | "arrivalTime">[] = [
    ...
    { airlineId: "tap", flightNumber: "TP 289", origin: "LIS", destination: "LAD", duration: "7h 00min", price: 800000, currency: "AOA", availableSeats: 75, totalSeats: 250, aircraft: "Airbus A330-900", stops: 0, class: "economy", hasCheckedBaggage: true },
    { airlineId: "tap", flightNumber: "TP 287", origin: "LIS", destination: "LAD", duration: "7h 00min", price: 2500000, currency: "AOA", availableSeats: 22, totalSeats: 30, aircraft: "Airbus A330-900", stops: 0, class: "business", hasCheckedBaggage: true },
